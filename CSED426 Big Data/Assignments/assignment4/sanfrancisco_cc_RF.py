...
forestObj = RandomForestClassifier(max_depth=16,n_estimators=256, oob_score=True)
forest = forestObj.fit(df_train[attr_cols], df_train['CategoryEncoded'])
predictions = forest.predict_proba(df_test[attr_cols]).astype(float)
