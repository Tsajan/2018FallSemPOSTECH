...
forest = forestObj.fit(df_train[attr_cols], df_train['y'])
df_test_copy['y'] = forest.predict(df_test[attr_cols])

df_test_copy.to_csv('sample_bank_submission_RF.csv', index=False)